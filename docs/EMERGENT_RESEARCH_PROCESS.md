...
AI assistance: This document describes an AI-assisted research workflow.

Claim-status impact: No theorem-status change.

Scope: Retrospective methodology interpretation.

Purpose

This document records a public-safe interpretation of how the CRT research stack developed.

It is based on repository history, public artifacts, and internal process reflection.
...
The CRT research program is retrospectively understood as an emergent outcome of a constrained research process.

It was not designed top-down as a finished theory.

Instead, the public theory stack emerged through:

* founding principles
* disciplined AI-assisted execution
* adversarial audit
* context-reset review
* public correction
* status demotion when needed
* human final acceptance authority
...
This does not mean AI systems authored or validated the theory independently.
...
They helped identify when claims should be:

* narrowed
* demoted
* made conditional
* frozen
* moved to open problems
* marked superseded

Internal audit is not peer review.

Context-reset audit is not peer review.
...
Speed is not evidence of correctness.

Volume is not evidence of correctness.
...
* CRT was automatically discovered by AI
* AI systems independently authored CRT
* GitHub history proves CRT correctness
* internal audit equals peer review
